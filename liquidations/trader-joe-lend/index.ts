...
const subgraphUrl = `https://gateway-arbitrum.network.thegraph.com/api/${process.env.GRAPH_PROTOCOL}/subgraphs/id/JB5EdQqbddMjawMLYe3C5ifmhN9WKYvLdgAKoUy1CyYy`;
