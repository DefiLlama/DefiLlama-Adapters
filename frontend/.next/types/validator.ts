...
// Validate ../../src/app/api/solvency/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/solvency">> = Specific
  const handler = {} as typeof import("../../src/app/api/solvency/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
