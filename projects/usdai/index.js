...
async function tvl(api) {
  ...
  // Get loan repayments in Staked USDai
  const [repaymentLoanBalance, , ] = await api.call({
    target: STAKED_USDAI_CONTRACT,
    abi: abi.loanRouterBalances,
  })

  // Add loan repayment balance in Staked USDai
  api.add(USDAI_CONTRACT, repaymentLoanBalance);
