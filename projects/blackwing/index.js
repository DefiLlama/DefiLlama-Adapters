...
const EHTEREUM_MAINNET_PENDLE = "0x5cb12D56F5346a016DBBA8CA90635d82e6D1bcEa";
...
module.exports = {
  ...
  ethereum: {
    tvl: sumTokensExport({
      tokens: [ADDRESSES.ethereum.USDC, ADDRESSES.ethereum.WETH, ETHEREUM_MAINNET_RSWETH, ETHEREUM_MAINNET_RSETH, ETHEREUM_MAINNET_EZETH, ADDRESSES.ethereum.EETH, ETHEREUM_MAINNET_WEETH, ADDRESSES.ethereum.sUSDe, EHTEREUM_MAINNET_PENDLE
