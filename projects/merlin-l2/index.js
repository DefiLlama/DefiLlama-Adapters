...
module.exports = {
  ...
  ethereum: {
    tvl: sumTokensExport({
      ownerTokens: [
        ...
        [[ADDRESSES.ethereum.USDC], "0x8bb6cae3f1cada07dd14ba951e02886ea6bba183","0xe76BA6A4373f589c221AC5A7BAf98428645B64BE",],//usdc
        [["0x0000000000000000000000000000000000000000"],"0xC40329D3aE56Af6b0757C3fE53941DDCC3d92671","0xD9e92baA959C22A9E4B0463877B80B83a3ac0A54",]] //eth
    }),
  },
  arbitrum: {
    tvl: sumTokensExport({
  ...
  zkfair: {
    tvl: sumTokensExport({
      ...
      tokens: ["0x4b21b980d0Dc7D3C0C6175b0A412694F3A1c7c6b", "0x3f97bf3Cd76B5cA9D4A4E9cD8a73C24E32d6C193", "0x813bCb548F99Bc081e5EFeeAa65e3018befb92Ae","0x0000000000000000000000000000000000000000","0x1cD3E2A23C45A690a18Ed93FD1412543f464158F",] // eth usdt and wbtc and usdc and zkf
    }),
  },
};
