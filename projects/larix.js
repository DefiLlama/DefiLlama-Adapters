...
async function tvl() {
  return sumTokens([
    ...
    getTokenBalance(
      ...
      "BxnUi6jyYbtEEgkBq4bPLKzDpSfWVAzgyf3TF2jfC1my"
    ),
    //ethAmount
    getTokenBalance(
