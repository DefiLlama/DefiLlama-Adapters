...
async function harmonyTvl(timestamp, block, chainBlocks) {
  ...
  await addFundsInMasterChef(
    ...
    (addr) => {
      if (
        addr.toLowerCase() === "0x691f37653f2fbed9063febb1a7f54bc5c40bed8c" ||
        addr.toLowerCase() === "0x865b568f24f0a17dba3e358b24b0c35659b1f25a"
      ) {
    ...
    chefPoolInfo,
    [harmonyHMochi, harmonyStakingToken]
  );
  return balances;
}
