...
const FIABTC_CORE = '0x60C230c38aF6d86b0277a98a1CAeAA345a7B061F'
...
const coredao_tvl = async (api) => {
    const supply = await api.call({ abi: 'erc20:totalSupply', target: FIABTC_CORE })
    api.add(FIABTC_CORE, supply)
}
...
const aptos_tvl = async (api) => {
    ...
    api.add(FIABTC_APTOS, parseInt(supply))
}
