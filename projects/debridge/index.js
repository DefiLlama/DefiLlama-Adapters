...
const isValidToken = (t) => {
  const addrOk = t?.tokenAddress && isEvmAddress(t.tokenAddress)
  const name = typeof t?.tokenName === 'string' ? t.tokenName : ''
  const notDebridge = !name.startsWith('deBridge ')
  return addrOk && notDebridge
}
