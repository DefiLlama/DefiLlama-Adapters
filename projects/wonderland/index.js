...
async function avaxTvl(timestamp, ethBlock, chainBlocks) {
  ...
  await sumTokensAndLPsSharedOwners(
    balances,
    [
      [ADDRESSES.avax.USDt, false], // USDT
      [ADDRESSES.avax.USDC_e, false], // USDC.e
...
async function ethTvl(timestamp, ethBlock, chainBlocks) {
  ...
  await sumTokensAndLPsSharedOwners(
    ...
    [
      ...
      [ADDRESSES.ethereum.TUSD, false], // TUSD
      ...
      [ADDRESSES.ethereum.SNX, false], // SNX
      [ADDRESSES.ethereum.USDT, false], // USDT
