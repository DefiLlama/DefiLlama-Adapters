...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/u67kc-jyaaa-aaaaq-aabpq-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for ICX`,
  icp: { tvl: tvl },
}