...
const subgraphUrls = {
  ...
  arbitrum:
    `https://gateway-arbitrum.network.thegraph.com/api/${process.env.GRAPH_PROTOCOL}/subgraphs/id/2XQDRQ9AXhp5us6PsNyRM5BxKWeXhy3BNQLynA6YmmjA`,
  fantom:
    "https://api.thegraph.com/subgraphs/name/olympusdao/protocol-metrics-fantom",
  polygon:
    `https://gateway-arbitrum.network.thegraph.com/api/${process.env.GRAPH_PROTOCOL}/subgraphs/id/JCVMW1dbqectgaSLRuKSen6FKe9RPMJRQhNYZa4iTgFb`,
};
