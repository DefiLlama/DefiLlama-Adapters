...
module.exports = {
  ...
  methodology: `Tokenik's TVL consists of only staked RNIK on Ethereum until the official Tokenik v2 launch. At that time, the RNIK token contract will also be deployed. Currently, the RNIK token is only a balance on the staking/rewards contracts with a value of $1 when used in the Tokenik ecosystem.`,
  ethereum: {
    tvl: () => ({}),
