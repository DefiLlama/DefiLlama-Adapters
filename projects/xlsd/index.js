...
async function calcTvl(timestamp, block, chainBlocks, { api }) {
  return sumTokens2({ api, tokensAndOwners2: [LSD_TOKENS, STAKING_POOL_ADDRESS], chain: 'arbitrum', blacklistedTokens: BLACKLISTED_TOKENS});
}
