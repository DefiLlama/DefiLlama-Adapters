...
const graphUrls = {
  bsc: "https://api.thegraph.com/subgraphs/name/redallica/orion-protocol",
};
...
async function bscTvl(timestamp, ethBlock, chainBlocks) {
  ...
  const balances = calculateUniTvl(
    ...
    chainBlocks.bsc,
    "bsc",
    "0xE52cCf7B6cE4817449F2E6fA7efD7B567803E4b4",
    0,
    true
  );
...
module.exports = {
  methodology:
    "The Factory address is used to find the liquidity in each of the LP pairs",
  bsc: {
    tvl: bscTvl,
  },
  ethereum: {
