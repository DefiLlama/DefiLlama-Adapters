...
const ynUSDx = '0x3DB228FE836D99Ccb25Ec4dfdC80ED6d2CDdCB4b'
...
module.exports = {
  ...
  ethereum: {
    tvl: async (api) => {
      ...
      const maxvaults = await api.erc4626Sum({ calls: [yn_ETHx, ynUSDx], isOG4626: true})
      api.add(ADDRESSES.null, maxvaults)
