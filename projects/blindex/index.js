...
// 2. create a function to calculate the TVL of the chain (similar to what we did with the 'rootstockTvl' function)
// 3. Add your new chain to the export module
// 4. Add your new chain to the 'sumChainTvls' function in the export module
//-------------------------------------------------------------------------------------------------------------

// Test on the Rootstock network:
...
const chains = {
  rootstock: {
    ...
    coingeckoMapping: {
      prefix: "rootstock",
      "0x542fda317318ebf1d3deaf76e0b632741a7e677d": "rootstock", // Rootstock's WRBTC
      "0x1d931bf8656d795e50ef6d639562c5bd8ac2b78f": "ethereum", // Rootstock's ETHs
      "0xb450ff06d950efa9a9c0ad63790c51971c1be885": "usd-coin", // Rootstock's BDUS - USD stable
      "0x99ac494badd0cba26143bd423e39a088591c7b09": "tether-eurt", // Rootstock's BDEU, - Euro stable
      "0xa4a8fb98a26e5314397170e5d12da8b73dc2ceb5": "pax-gold", // Rootstock's bXAU, - Gold stable
      "0x2415e222755fd1f07b0a565eb4f036e410852ee0":
        "jarvis-synthetic-british-pound", // Rootstock's bGBP - British Pound Stable
      "0xb5999795be0ebb5bab23144aa5fd6a02d080299f": "usd-coin", // Rootstock's XUSD, - USD stable
      "0xe700691da7b9851f2f35f8b8182c69c53ccad9db": "usd-coin", // Rootstock's DOC - USD stable
    },
  },
};
...
const rootstock = async function rootstockTvl(timestamp, ethBlock, chainblocks) {
  return tvl("rootstock", chainblocks.rootstock);
};
...
module.exports = {
  ...
  rootstock: {
    tvl: sdk.util.sumChainTvls([rootstock, dexTVL]),
  },
};
