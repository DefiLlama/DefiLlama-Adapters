...
async function tvl(timestamp, block) {
  const result = await request(graphUrl, query, {
    bAssetTokenBalanceQuery:
      '{"balance":{"address":"terra1ptjp2vfjrwh0j0faj9r6katm640kgjxnwwq9kn"}}',
    bEthTokenBalanceQuery:
      '{"balance":{"address":"terra10cxuzggyvvv44magvrh3thpdnk9cmlgk93gmx2"}}',
  });
