...
// Contract addresses for APL token
...
async function getStakedValue(api) {
...
async function tvl(api) {
  // Main TVL includes staked APL tokens
  return getStakedValue(api);
}

async function staking(api) {
  // Staking category shows the same staked APL tokens
  return getStakedValue(api);
}
...
module.exports = {
  ...
  start: 5630479, // APL Launch (June 25, 2025)
  sty: {
    tvl,
    staking,
  },
  hallmarks: [
    [1750880683, "APL Token Launch"], // Jun 25 2025 12:44:43 PM PDT
  ],
}; 