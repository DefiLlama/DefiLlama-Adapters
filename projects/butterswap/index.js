  ...
  return await calculateUniTvl(
    (addr) => {
      if (addr.toLowerCase() === "0x5545153ccfca01fbd7dd11c0b23ba694d9509a6f") {
        ...
        addr.toLowerCase() === "0xdd86dd2dc0aca2a8f41a680fc1f88ec1b7fc9b09"
      ) {
        return "0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce";
      } else if (
        addr.toLowerCase() === "0x311bcb634a4111e6516d3899f9fbfbfe984f021a"
      ) {
        return "0xb2e260f12406c401874ecc960893c0f74cd6afcd";
      } else if (
        addr.toLowerCase() === "0xdb11743fe8b129b49b11236e8a715004bdabe7e5"
      ) {
        return "0x7d1afa7b718fb893db30a3abc0cfc608aacfebb0";
      } else if (
        addr.toLowerCase() === "0x40280e26a572745b1152a54d1d44f365daa51618"
      ) {
        return "bsc:0xba2ae424d960c26247dd6c32edc70b295c744c43";
      } else if (
        addr.toLowerCase() === "0x4f99d10e16972ff2fe315eee53a95fc5a5870ce3"
      ) {
...
async function bscTvl(timestamp, block, chainBlocks) {
  return await calculateUniTvl(
    (addr) => {
      ...
      if (
        addr === "0x2f3bca2631fff538b8a55207f6c2081457e229f7" ||
        addr === "0x5ef7814f4cb17b38408f1f641e4b5b61c5d023a8"
      ) {
