...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/gkoex-viaaa-aaaaq-aacmq-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for ElnaAI`,
  icp: { tvl: tvl },
}