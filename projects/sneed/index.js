...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/fp274-iaaaa-aaaaq-aacha-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for Sneed`,
  icp: { tvl: tvl },
}