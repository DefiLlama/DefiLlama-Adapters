...
const config = {
  ethereum: {
    vaults: [
      ...
      '0xbfc5770631641719cd1cf809d8325b146aed19de',
...
Object.keys(config).forEach(chain => {
  ...
  module.exports[chain] = {
    tvl: async (api) => {
      if (tokens) {
        return sumTokens2({ api, owners: vaults, tokens })
      }
      return sumTokens2({ api, owners: vaults, fetchCoValentTokens: true, tokenConfig: { onlyWhitelisted: false } })
    }
  }
})

module.exports.methodology = 'TVL is the total value of assets deposited in Nest Credit vaults across all chains'
