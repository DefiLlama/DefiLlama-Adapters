...
async function tvl(api) {
  ...
  if (api.chain === 'polygon') {
    api.add(ADDRESSES.polygon.WBTC, totalSupplyInBtc)
  } else {
    api.add(ADDRESSES.ethereum.WBTC, totalSupplyInBtc)
  }
}

module.exports = {
  polygon: { tvl,staking: staking('0x015CEe3aB6d03267B1B2c05D2Ac9e2250AF5268d', prxy, 'polygon') },
  ethereum: { tvl },
