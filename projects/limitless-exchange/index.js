...
const config = [
  ...
  { factory: "0xc397D5d70cb3B56B26dd5C2824d49a96c4dabF50", resolver: "0x8f4fA186E00E376a9054968a03172cfa1c2EedfE", fromBlock: 39598822 },
];
...
const getMarkets = async ({ factory, resolver, fromBlock }, api) => {
  ...
  return api.sumTokens({ owner: resolver, tokens, blacklistedTokens });
};
