...
async function tvl(api) {
  ...
  // the graduated ones are counted by the megapump-dex entry in registries/uniswapV2.js.
...
module.exports = {
  methodology:
    'TVL is the ETH locked in active bonding curves (sum of totalRaised over tokens that have not graduated, read from the MegaPump factory). Accrued platform and creator fees held by the factory are excluded.',
  start: '2026-07-10',
  megaeth: { tvl },
}
