  ...
  if (chain === 'berachain') {
    ...
    module.exports[chain] = {
      tvl: async (api) => {
        ...
        balance = await api.call({ abi: 'function balanceOf(address) view returns (uint256)', target: '0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34', params: ['0x9A319b57B80c50f8B19DB35D3224655F3aDd8E4f'] })
