...
async function fetch() {
  ...
  var tvl = await new BigNumber((parseFloat(stars.data.bonded_tokens)) + parseFloat(p_osmo.data.symbol.amount) + parseFloat(p_atom.data.symbol.amount) + parseFloat(p_ststars.data.symbol.amount)).div(10 ** 6).toFixed(2);
