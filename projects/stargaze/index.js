...
async function fetch() {
  ...
  var tvl = await new BigNumber(parseFloat(stars.data.bonded_tokens / (10 ** 6)) + parseFloat(p_osmo.data.symbol.amount) + parseFloat(p_atom.data.symbol.amount) + parseFloat(p_ststars.data.symbol.amount));
