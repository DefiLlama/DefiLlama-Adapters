...
// ---- Additional kpk-managed DAO treasuries (time-gated; see TIME_GATED_ENTITIES) ----
const AAVE_DAO_SAFES = [
  '0x205e795336610f5131be52f09218af19f0f3ec60','0xa1c93d2687f7014aaf588c764e3ce80af016229b','0xcdb4fa6ba08bf1fb7aa9fdf6002e78edc431a642','0x2ce01c87fec1b71a9041c52caed46fc5f4807285','0xa9e777d56c0ad861f6a03967e080e767ad8d39b6','0xcaf8155d99a0d11567f039422bb8a0ba003788e5',
]
const GNOSIS_DAO_SAFES = [
  '0x458cd345b4c05e8df39d0a07220feb4ec19f5e6f','0x23b4f73fb31e89b27de17f9c5de2660cc1fb0cdf','0x6bbe78ee9e474842dbd4ab4987b3cefe88426a92','0xeb1f08afcc4da307ae4ccef00daf53488aa76979','0x6378a40df79583eaa6ce70e951ba7da45ceb4fc7','0x10720f58cf4a22fa540ff10430fd967d2ef102de','0x9065a0f9545817d18b58436771b4d87bda8f008b','0x509ad7278a2f6530bc24590c83e93faf8fd46e99','0x1a3221e5a1daf12b39bfff0ef8a066029e50e6fe','0x095e194302e851e1ddbd2795c0180b889ad01fef','0x12dbe8705144fdbed126c818fc60faf5d679112b','0x2730a02aef900520104adc8fd76b03e8c4be4bbb','0x8cdb8ae1f5bb1d7d509c28685864ed70669cc63d','0x49e8d6cbc93b36d356266d2e93ddee7fe475125f','0xbf751b5a46c80930f4596d6bc72da81c2ec2b235','0xb5695594f30b9a10889f30108248f8cfda43341b','0x43e2e12a8c294657d94fe80bda9dd380e0598f4c','0x8cc90c889b6e108976d3f66b5292570637350c7d','0x87b6a922794a223eca493fb65dcaf44462843c2a','0xeb5cd25a3855d21e3db6c5ccd8e78d43258aabe8','0xca308c6b015f9ba3625d576a02e96d7cec58b932','0x07643179f63f1e10c6ca04cccc6aba2db71fd60a','0x849d52316331967b6ff1198e5e32a0eb168d039d','0xf51842ebf4dc1e6f89d74ab0768c670ab04d928b','0x2923c1b5313f7375fdaee80b7745106debc1b53e','0xa5c629e04e563355c30885b62928fd6e03558548','0x15a954001bb47890a4c46a7fe9f06f7c39ff3d68','0xce0ef49b8fcd85531327abeabad10ea641299365','0x7eea4286e9e82ba332f49400d037609bb1cf00da','0x5b6e1acd8494092c166b390c17f09694b9ddb42c','0x210ff2e26599d7146753bcbbc93afedf82d2802f','0x7ce63a765341bc274fd5c5c4d80b17ac26f2062f','0x3115f77805fe59ef9a31d5b38c68c171665cbb53',
]
const SAFE_GNOSIS_SAFES = [
  '0xd28b432f06cb64692379758b88b5fcdfc4f56922','0x0c6eeb232800fb86215438c4f7ae032b5463586c',
]

const ZODIAC_CHAINS = ['ethereum', 'xdai', 'arbitrum', 'base', 'polygon', 'optimism', 'bsc']
...
const SAFE_GNOSIS_TOKENS = {
  ethereum: ['0x2e7E978DA0C53404a8cf66ED4bA2c7706C07B62a','0x93d199263632a4EF4Bb438F1feB99e57b4b5f0BD','0x1e19cf2d73a72ef1332c882f20534b6519be0276','0xbF8868b754A77E90Ea68ffC0b5B10A7c729457E1','0xAC0F906E433d58FA868F936E8A43230473652885'],
...
const AAVE_DAO_TOKENS = {
  ethereum: ['0x00A7BA8Ae7bca0B10A32Ea1f8e2a1Da980c6CAd2','0x3fa73f1e5d8a792c80f426fc8f84fbf7ce9bbcac','0xac16927429c5c7af63dd75bc9d8a58c63ffd0147','0xD1b5651E55D4CeeD36251c61c50C889B36F6abB5','0xaa0C3f5F7DFD688C6E646F66CD2a6B66ACdbE434','0x6c3f90f043a72fa612cbac8115ee7e52bde6e490'],
}
...
const toTs = (d, endOfDay) => Math.floor(new Date(d + (endOfDay ? 'T23:59:59Z' : 'T00:00:00Z')).getTime() / 1000)
const isEntityActive = (cfg, ts) => ts >= toTs(cfg.start) && ts <= toTs(cfg.end, true)
...
async function getNexusStakedNXM(api) {
  ...
  const tokens = await api.call({ target: NEXUS_STAKING_VIEWER, abi: NEXUS_GET_TOKENS_ABI, params: [ours], permitFailure: true })
  if (!tokens) return
  let nxmWei = 0n
