...
async function tvl(api) {
  const pools = (await api.multiCall({ calls: [aggregator, solvBtcMFarmAddress, solvBtcCoreFarmAddress,coreDaoFarmAddress,wbtcFarmAddress,coreDaoFarmAddress2,solvBtcBFarmAddress], abi: abis.getTotalTvl })).flat()
