...
const config = {
  ...
  avax: { factory: '0x85b0F66E83515ff4e825DfCAa58E040E08278EF9', fromBlock: 34309521,  vault: '0xbe5D56B08055d7b6e9f780DfeA262512a2D2d950', vaultFromBlock:42536874 },
  ...
  zklink: { factory: '0x335c04321E88631A99F78fD7D7C4f49A921ed924', fromBlock: 443, vault: '0x4AC97E2727B0e92AE32F5796b97b7f98dc47F059', vaultFromBlock:452 },
}
  ...
  module.exports[chain] = {
    tvl: async (_, _b, _cb, { api, }) => {
      ...
      if(vault){
        ...
        const underlyingTokens = await api.multiCall({abi: 'address:underlying', calls:lpTokens})
      ...
      return await sumTokens2({ api, ownerTokens: treasuries.map((v, i) => [[nullAddress, ...tokenAs[i], ...tokenBs[i]], v]) })
