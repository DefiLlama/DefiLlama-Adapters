...
Object.keys(contractFarms).forEach(chain => {
	const owners = contractFarms[chain]
	const tokens = lps[chain]
	if (!module.exports[chain]) module.exports[chain] = {}
	module.exports[chain].pool2 = sumTokensExport({ tokens, owners, resolveLP: chain === 'bsc' })
	module.exports[chain].staking = sumTokensExport({ tokens: [dyp], owners, })
})