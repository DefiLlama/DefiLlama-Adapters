...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/4m6il-zqaaa-aaaaq-aaa2a-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for ICGhost`,
  icp: { tvl: tvl },
}