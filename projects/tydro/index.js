...
const ADDRESSES = ['0x96086C25d13943C80Ff9a19791a40Df6aFC08328'];
...
module.exports.ink = {
  tvl: (api) => fetchReserveData(api, ADDRESSES),
  borrowed: (api) => fetchReserveData(api, ADDRESSES, true),
};

module.exports.hallmarks = [
    // TODO add these in as they occur
]