...
async function fetch() {
  ...
  let response = await retry(
    async (bail) =>
      await axios.get(
        "https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress=0x2260fac5e5542a773aa44fbcfedf7c193bc2c599&apikey=H6NGIGG7N74TUH8K2X31J1KB65HFBH2E82"
      )
  );
