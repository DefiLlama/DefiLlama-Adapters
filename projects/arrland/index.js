...
module.exports = {
  polygon: {
    tvl: sumTokensExport({ owners: ['0xEAf6E84B4E4C2Ce70a80fd781B6A7f177E7b60F5', '0xb94380939A15C574FE22B04FC95Ec5CCaAD783b8'], tokens: ['0x14e5386f47466a463f85d151653e1736c0c50fc3'] }),
    staking: stakings(stakingAddresses, stakingToken, "polygon"),
    pool2: pool2s(pool2StakingAddresses, lpTokens, "polygon")
  },
  methodology: "Counts total value locked as $RUM tokens locked in LP staking, the $RUM token staking, LP token staking",
}