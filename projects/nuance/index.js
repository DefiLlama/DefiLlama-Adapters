...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/rzbmc-yiaaa-aaaaq-aabsq-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for Nuance`,
  icp: { tvl: tvl },
}