...
function getstableOwnersAndToken() {
  const tokensAndOwners = []
  for (const stabilityPool of GAI_STABILITY_POOL) {
    tokensAndOwners.push([GAI_TOKEN_ADDRESS, stabilityPool])
  }
  return tokensAndOwners;
}
