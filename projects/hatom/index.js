...
const calcLiquidStakingExchangeRate = (
   cashReserve,
   totalShares
) => {
   if (totalShares === '0') {
...
async function tvl() {
   ...
   const liquidStakingElrndReserveInUSD = (BigNumber(liquidStakingElrndReserveInEgld).dividedBy(1e18)).multipliedBy(egldUsdcPrice)
