...
async function fetch() {
  ...
  let response = await retry(
    async (bail) =>
      await axios.get(
        "https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress=0x0316EB71485b0Ab14103307bf65a021042c6d380&apikey=H6NGIGG7N74TUH8K2X31J1KB65HFBH2E82"
      )
  );
