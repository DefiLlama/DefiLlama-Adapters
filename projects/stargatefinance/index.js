    ...
    tvl: async (_, _b, _cb, { api }) => {
      return {
        [ADDRESSES.ethereum.WETH]: await api.call({
          abi: "erc20:balanceOf",
          target: "0xdD69DB25F6D620A7baD3023c5d32761D353D3De9",
          params: ["0x88124ef4a9ec47e691f254f2e8e348fd1e341e9b"],
        }),
      };
    },
  },
...
Object.keys(CONFIG).forEach((chain) => {
  ...
  if (stakingContract && stg) {
    try {
      staking = stakings([stakingContract], [stg]);
    } catch (error) {
      console.error("Error with stakings:", error);
    }
  }
  ...
  module.exports[chain] = {
    tvl: async (_, _b, _cb, { api }) => {
      ...
      const pools = await api.fetchList({
        lengthAbi: abi.allPoolsLength,
        itemAbi: abi.allPools,
        target: factory,
      });
