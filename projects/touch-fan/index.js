...
module.exports = {
    ...
    era: {
        tvl: sumTokensExport({
            tokensAndOwners: [
                [nullAddress, fan_contract],
                [nullAddress, touch_contract],
                [tft_address, lock_tft_address],
                [tft_address, vester_address],
                [tft_address, stake_tft_contract_address],
                [zk_sync_swap_pool, lock_lp_address]
            ],
