...
const chains = ["arbitrum", "ethereum", "optimism", "polygon", "avax", "xdai", "bsc", "celo"];
// const tokens = ["USDC", "USDT", "CRV", "CVX", "DAI"];
const treasuryTokens = (tokens) => {
    const treasury = {};
    tokens.forEach(tokenSymbol => chains.forEach(chain => {
        const token = ADDRESSES[chain]?.[tokenSymbol];
...
const stablecoin = {
  EUR: {
    ...
    treasuryTokens: treasuryTokens(["USDC", "USDT", "CRV", "CVX", "DAI"]),
    genesis: 1691656362,
  },
  USD: {
