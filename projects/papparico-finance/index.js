...
module.exports = {
  methodology: 'Papparico Finance TVL.',
  start: 13406569,
  cronos: {
      tvl: sumTokensExport({ 
        tokensAndOwners: [
          [PPFT_TOKEN_CONTRACT, STAKING_CONTRACT],
          [PPFT_TOKEN_CONTRACT, SINGLE_STAKING_CONTRACT],
          [PPFT_TOKEN_CONTRACT, VAULTS_CONTRACT],
          [PPFT_MAIN_LP, LP_MINING_CONTRACT],
        ],
        resolveLP: true,
      }),
  }
