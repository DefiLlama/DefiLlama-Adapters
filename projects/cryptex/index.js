...
module.exports = {
  methodology:
    "TVL is calculated by the WETH and DAI used to mint TCAP. Pool2 TVL is calculated from the SLP staked in the SushiSwap pools. Staking TVL is calculated by the CTX staked in the DelegatorFactory. Treasury TVL is calculated by the CTX and ETH in the treasury contract.",
  ethereum: {
    tvl,
    pool2,
    staking,
