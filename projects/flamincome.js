...
async function fetch() {
  var price_feed = await retry(
    async (bail) =>
      await axios.get(
        "https://api.coingecko.com/api/v3/simple/price?ids=ethereum,tether,wrapped-bitcoin&vs_currencies=usd&include_market_cap=true&include_24hr_vol=true&include_24hr_change=true"
      )
  );
  ...
  const stakingAssets = [
    ...
    {
      contract: "0x1a389c381a8242B7acFf0eB989173Cd5d0EFc3e3",
      slug: "wrapped-bitcoin",
    },
    {
      contract: "0x1E9DC5d843731D333544e63B2B2082D21EF78ed3",
      slug: "ethereum",
    },
  ];
