...
async function gearboxStyleTVL({ api }) {
    // Get live data from Gearbox-style lending function using DataCompressor V3
...
module.exports = {
    methodology: "Nexion's Gearbox-style lending protocol supports 10 pools currently.",
    pulse: {
        tvl: gearboxStyleTVL,
    },
};