...
const contracts = {
  ARBI_POOL: "0x6Ec7B10bF7331794adAaf235cb47a2A292cD9c7e",
...
module.exports = {
  ...
  arbitrum: {
    ...
    tvl: async (_, _b, {arbitrum: block}) => sumTokens2({ chain: 'arbitrum', block, tokens: [tokens.USDC], owners: [contracts.ARBI_POOL]}),
  },
  hallmarks: [
