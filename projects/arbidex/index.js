const { uniV3Exports } = require('../helpers/uniswap.js');
...
module.exports = uniV3Exports({
  [ARBITRUM]: { 
    factories: FACTORIES[ARBITRUM],
    poolWhitelists: POOL_WHITELIST[ARBITRUM],
    enableStaking: true, // Add stakers if needed
    stakingContracts: [
  ...
  methodology: 'TVL counts liquidity in Quantum Pools (concentrated), standard pools via factories, and staking contracts (ARXPool, Earn pools, AC). Uses uniV3Exports for V3-style handling with whitelisted pools and strategies.',
  timetravel: true,
