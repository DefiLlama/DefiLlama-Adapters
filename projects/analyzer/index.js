...
module.exports = {
  ...
  linea: {
    tvl: sumTokensExport({ owner: contracts.linea, tokens: [null] })
  },
  arbitrum: {
    tvl: sumTokensExport({ owner: contracts.arbitrum, tokens: [null] })
  },
  ethereum: {
    tvl: sumTokensExport({ owner: contracts.ethereum, tokens: [null] })
  },
  base: {
    tvl: sumTokensExport({ owner: contracts.base, tokens: [null] })
  },
  bsc: {
    tvl: sumTokensExport({ owner: contracts.bsc, tokens: [null] })
  }
}
