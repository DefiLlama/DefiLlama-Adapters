...
module.exports = {
  methodology: "Counts the total value of vesting tokens locked in SecondSwap vault contracts. SecondSwap enables trading and management of locked/vesting cryptocurrencies across multiple chains.",
  ethereum: { tvl },
  avax: { tvl },
  solana: { tvl },
};
