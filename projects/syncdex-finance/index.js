...
const assets = [
  ...
  "0x3a34FA9a1288597Ad6C1Da709f001D37FeF8b19e", // We have SYDX pool so we add here
  "0x0000000000000000000000000000000000000000" // This is address of native token (ETH), you can check native_staking_contract
];

module.exports = {
  era: {
    tvl: sumTokensExport({ owners: [native_staking_contract, usdc_staking_contract, sydx_staking_contract, native_usdc_farming_contract, native_sydx_farming_contract, sydx_usdc_farming_contract], tokens: assets}),
    staking: sumTokensExport({ owners: [native_staking_contract, usdc_staking_contract, sydx_staking_contract, native_usdc_farming_contract, native_sydx_farming_contract, sydx_usdc_farming_contract], tokens: assets}),
  },
};