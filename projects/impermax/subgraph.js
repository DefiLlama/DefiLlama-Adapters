...
const chainTvl = getChainTvl(
  Object.fromEntries(
    Object.entries(subgraphs).map((s) => [
      s[0],
      s[1].startsWith("http")
        ? s[1]
        : "https://api.thegraph.com/subgraphs/name/" + s[1],
    ])
  ),
  "impermaxFactories",
  "totalBalanceUSD"
...
const subgraphChainTvls = Object.keys(subgraphs).reduce(
  (obj, chain) => ({
    ...obj,
...
module.exports = {
  ...
  tvl: sdk.util.sumChainTvls(
    Object.values(subgraphChainTvls).map((tvl) => tvl.tvl)
  ),
};
