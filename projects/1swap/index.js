...
const poolTvl = async (chain, poolAddress, block) => {
  ...
  tokens.output.forEach((token, i) => {
    ...
    sum[symbol] = new BigNumber(balances.output[i])
...
const moonriverTvl = async (timestamp, ethBlock, chainBlocks) => {
  ...
  for (let address of Object.values(Contracts.moonriver.pools)) {
    const balances = await poolTvl("moonriver", address, block);
...
function getTokenId(address) {
  switch (address) {
    ...
    case "0x965f84d915a9efa2dd81b653e3ae736555d945f4":
      return ["frax", 18];
    case "0xd8b99eae34afdf1a9bfa5770066404ee4468d0f2":
      return ["usdc.e", 6];
    case "0xf97c8556af29089d5d1627096958187b11f1915c":
      return ["usdt.e", 6];
    case "0x26dfff76d9123a1c79279abc29b676c48a8bd77e":
      return ["dai.e", 18];
    default:
      return false;
  }
