...
const vf = VAULT_FACTORIES;
vf.add(VAULT_FACTORY_A);
vf.add(VAULT_FACTORY_APE_STAKING_A);

const START_BLOCKS = new Map();
const sb = START_BLOCKS;
sb.set(VAULT_FACTORY_A, 15045028);
sb.set(VAULT_FACTORY_APE_STAKING_A, 16128500);
