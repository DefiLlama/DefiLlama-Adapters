...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/tw2vt-hqaaa-aaaaq-aab6a-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for GoldDAO`,
  icp: { tvl: tvl },
}