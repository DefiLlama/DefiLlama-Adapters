...
// @dev: mapping of XCHF, VCHF, CHFAU to its Bridges
...
const CHFAUBridge = ["0xBD4DfC058eb95b8De5ceAF39966A1a70F5556F78", "0x3e445ff4ddDf0ff8aE7458c9746eD80bD664F6C1"];

async function tvl(api) {
  // @dev: register bridged token as collateral for backing and TVL
  const tokensAndOwners = [XCHFBridge, VCHFBridge, CHFAUBridge];
