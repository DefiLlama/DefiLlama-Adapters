...
async function tvl() {
  const [
    ...
    getTokenBalance(
      ...
      "2wszCpUdVDFrJcP79wpV3FdBmU38UC1YKuoSUBA5mhWu"
    ),
    getTokenBalance(
      "CDJWUqTcYTVAKXAVXoQZFes5JUFc7owSeq7eMQcDSbo5",
      "2wszCpUdVDFrJcP79wpV3FdBmU38UC1YKuoSUBA5mhWu"
    ...
    getTokenBalance(
      ...
      "G4cRef4AxEjaSV32xqQzDmHqi3iz8112LQwx8oPbZhYb"
    ),
    getTokenBalance(
      "CDJWUqTcYTVAKXAVXoQZFes5JUFc7owSeq7eMQcDSbo5",
      "G4cRef4AxEjaSV32xqQzDmHqi3iz8112LQwx8oPbZhYb"
    ...
    getTokenBalance(
      ...
      "ASpJBf8HtyrNxaMqFNpjYCqi8SsJC5h56hd3HQUNk6M7"
    ),
    getTokenBalance(
      "FYpdBuyAHSbdaAyD1sKkxyLWbAP8uUW9h6uvdhK74ij1",
      "2hAy2ubWi3PWrgxSoamzonLy1bUL3BfoqW7u7791Qpj9"
    ),
    getTokenBalance(
      "AJ1W9A9N9dEMdVyoDiam2rV44gnBm2csrPDP7xqcapgX",
      "FDndRkBVpFoNBHY6Jhx7PgNpysvZjt3P2MZ95vmkSfWa"
    ),
    getTokenBalance(
      "8L8pDf3jutdpdr4m3np68CL9ZroLActrqwxi6s9Ah5xU",
      "GUotxHmyJVsJYWYoL8Vo6SKQweNRUZMRQcoqDe5PswHt"
    ),
    getTokenBalance(
      "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",
    ...
    getTokenBalance(
      ...
      "4HP9xSxLcEK64zALBCP36GdfDLrMXorVk4X6DyLrBjbp"
    ),
    getTokenBalance(
    ...
    getTokenBalance(
      ...
      "2mUxDu8NrhSKhQJMgKfYLxJqZzeEbmwhQdHeHMyohyuk"
    ),
    getTokenBalance(
      "88881Hu2jGMfCs9tMu5Rr7Ah7WBNBuXqde4nR5ZmKYYy",
      "AZCBmDBcFsA2jHHhfFJBTsWCHx9XnnKmGfFsue3ZVW1t"
    ),
  ]);
  return {
