...
async function tvl() {
    const [usdcAmount, usdtAmount, paiAmount, usdcAmount_2, btcAmount, renBtcAmount, pbtcAmount, renBtcAmount_2, ustAmount, daiAmount, busdAmount, fraxAmount, usdcAmount_3, wlunaAmount, renLunaAmount] = await Promise.all([
        //usdc-usdt pool
    ...
    return {
        ...
        'tether': usdtAmount,
        'renbtc': renBtcAmount + renBtcAmount_2,
        'terrausd': ustAmount,
        'dai': daiAmount,
        'busd': busdAmount,
