// Tokens added to this list must have a Chainlink price oracle so that they can be priced.
// They must also implement the abi balanceOf(address) so the number of tokens owned
