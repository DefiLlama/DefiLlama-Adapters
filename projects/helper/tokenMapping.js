...
const fixBalancesTokens = {
  ...
  ftn: {
    ...
    '0x498d1cf9ad2d66144c98057a5880ee16e801e2f7': { coingeckoId: 'fasttoken', decimals: 18 }, //done
  },
  q: {
      [ADDRESSES.q.ELK]: { coingeckoId: "elk-finance", decimals: 18 }, //done
      [ADDRESSES.q.WETH]: { coingeckoId: "ethereum", decimals: 18 }, //done
  },
  degen: {
    '0xf058eb3c946f0eaeca3e6662300cb01165c64ede': { coingeckoId: 'ethereum', decimals: 18 }, //done
  },
  stacks: {
    "SM26NBC8SFHNW4P1Y4DFH27974P56WN86C92HPEHH.token-vlqstx::vlqstx": { coingeckoId: "blockstack", decimals: 6 }, // no clue what is the symbol
    "SP2XD7417HGPRTREMKF748VNEQPDRR0RMANB7X1NK.token-abtc::bridged-btc": { coingeckoId: "xlink-bridged-btc-stacks", decimals: 8 }, //done
    "SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.token-alex::alex": { coingeckoId: "alexgo", decimals: 8 }, //done
  },
  stellar: {
    [ADDRESSES.stellar.XLM]: { coingeckoId: "stellar", decimals: 7}, //done
    [ADDRESSES.stellar.USDC]: { coingeckoId: "usd-coin", decimals: 7}, //done
  },
  defichain_evm: {
    [ADDRESSES.defichain_evm.DFI]: { coingeckoId: "defichain", decimals: 18 }, //done
    [ADDRESSES.defichain_evm.USDT]: { coingeckoId: "usd-coin", decimals: 18 }, //done
    [ADDRESSES.defichain_evm.USDC]: { coingeckoId: "tether", decimals: 18 }, //done
    [ADDRESSES.defichain_evm.ETH]: { coingeckoId: "ethereum", decimals: 18 }, //done
    [ADDRESSES.defichain_evm.DUSD]: { coingeckoId: "decentralized-usd", decimals: 18 }, //done
    '0x66F3Cf265D2D146A0348F6fC67E3Da0835e0968E': { coingeckoId: "javsphere", decimals: 18 }, //done
  },
  ace: {
    [nullAddress]: { coingeckoId: "endurance", decimals: 18 }, //done
    '0x85119527cf38f6ccf7b1b8f8fad05145358aaa81': { coingeckoId: "endurance", decimals: 18 }, //done
  },
  massa: {
    'AS12U4TZfNK7qoLyEERBBRDMu8nm5MKoRzPXDXans4v9wdATZedz9': { coingeckoId: 'wrapped-massa', decimals: 9 }, //done
    'AS1hCJXjndR4c9vekLWsXGnrdigp4AaZ7uYG3UKFzzKnWVsrNLPJ': { coingeckoId: 'massa-bridged-usdc-massa', decimals: 6 }, //done
    'AS1ZGF1upwp9kPRvDKLxFAKRebgg7b3RWDnhgV7VvdZkZsUL7Nuv': { coingeckoId: 'massa-bridged-dai-massa', decimals: 18 }, //done
    'AS124vf3YfAJCSCQVYKczzuWWpXrximFpbTmX4rheLs5uNSftiiRY': { coingeckoId: 'wrapped-ether-massa', decimals: 18 }, //done
  },
  // Sample Code
  ozone: {
  ...
  scroll: {
    [ADDRESSES.mode.STONE]: { coingeckoId: "ethereum:0x7122985656e38bdc0302db86685bb972b145bd3c", decimals: 0 }, //done wrong decimals
    '0x3ba89d490ab1c0c9cc2313385b30710e838370a4': { coingeckoId: "solv-btc", decimals: 18 }, //done
    '0x01f0a31698c4d065659b9bdc21b3610292a1c506': { coingeckoId: "ethereum:0xCd5fE23C85820F7B72D0926FC9b05b43E359b7ee", decimals: 0 }, //done wrong decimals
  },
  tezos: {
    "KT1PnUZCp3u2KzWr93pn4DD7HAJnm3rWVrgn": { coingeckoId: "tezos", decimals: 6 }, //done
    "KT18fp5rcTW7mbWDmzFwjLDUhs5MeJmagDSZ-17": { coingeckoId: "usd-coin", decimals: 6 }, //done
    "KT18fp5rcTW7mbWDmzFwjLDUhs5MeJmagDSZ-18": { coingeckoId: "tether", decimals: 6 }, //done
  },
  iotaevm: {
    "0x6e47f8d48a01b44DF3fFF35d258A10A3AEdC114c": { coingeckoId: 'iota', decimals: 18 }, //done
  },
  aurora: {
    '0x368ebb46aca6b8d0787c96b2b20bd3cc3f2c45f7': { coingeckoId: 'usd-coin', decimals: 6 }, //done
  },
  acala: {
  ...
  ham: {
    [ADDRESSES.optimism.WETH_1]: { coingeckoId: 'ethereum', decimals: 18 }, //DONE
  },
  blast: {
    '0x0000000000000000000000000000000000000001': { coingeckoId: 'ethereum', decimals: 18 }, //DONE
    '0xf7bc58b8d8f97adc129cfc4c9f45ce3c0e1d2692': { coingeckoId: "wrapped-bitcoin", decimals: 8 }, //DONE
    '0x9e0d7d79735e1c63333128149c7b616a0dc0bbdb': { coingeckoId: "weth", decimals: 18 }, //pirex eth //DONE
    '0xde55b113a27cc0c5893caa6ee1c020b6b46650c0': { coingeckoId: "deus-finance-2", decimals: 18 }, // deus //DONE
    [ADDRESSES.arbitrum.USDe]: { coingeckoId: "ethena-usde", decimals: 18 }, // DONE
  },
  solana: {
    'AZsHEMXd36Bj1EMNXhowJajpUXzrKcK57wW4ZGXVa7yR': { coingeckoId: "guacamole", decimals: 5 }, // DONE
  },
  chz: {
    '0x677F7e16C7Dd57be1D4C8aD1244883214953DC47': { coingeckoId: "wrapped-chiliz", decimals: 18 } // DONE
  },
  zklink: {
    '0xbEAf16cFD8eFe0FC97C2a07E349B9411F5dC272C': { coingeckoId: "solv-btc", decimals: 18 }, // DONE
    '0xFb8dBdc644eb54dAe0D7A9757f1e6444a07F8067': { coingeckoId: "bitcoin-trc20", decimals: 18 }, // DONE
    '0x85D431A3a56FDf2d2970635fF627f386b4ae49CC': { coingeckoId: "merlin-s-seal-btc", decimals: 18 }, // DONE
  },
  btr: {
    [ADDRESSES.null]: { coingeckoId: 'bitcoin', decimals: 18 }, // DONE
    '0xff204e2681a6fa0e2c3fade68a1b28fb90e4fc5f': { coingeckoId: 'wrapped-bitcoin', decimals: 18 }, // DONE
    '0xfe9f969faf8ad72a83b761138bf25de87eff9dd2': { coingeckoId: 'tether', decimals: 6 }, // DONE
    '0x9827431e8b77e87c9894bd50b055d6be56be0030': { coingeckoId: 'usd-coin', decimals: 6 }, // DONE

    // fix these by pricing the tokens in coins repo
    '0xd53E6f1d37f430d84eFad8060F9Fec558B36F6fa': { coingeckoId: 'wrapped-bitcoin', decimals: 18 }, // DONE
    '0xf6718b2701d4a6498ef77d7c152b2137ab28b8a3': { coingeckoId: 'wrapped-bitcoin', decimals: 18 }, // DONE
  ...
  bouncebit: {
    [ADDRESSES.null]: { coingeckoId: 'bouncebit', decimals: 18 }, //DONE
    '0xf4c20e5004c6fdcdda920bdd491ba8c98a9c5863': { coingeckoId: 'bouncebit', decimals: 18 }, //DONE
    '0x77776b40c3d75cb07ce54dea4b2fd1d07f865222': { coingeckoId: 'tether', decimals: 18 }, //DONE
    '0xF5e11df1ebCf78b6b6D26E04FF19cD786a1e81dC': { coingeckoId: 'bitcoin', decimals: 18 }, //DONE
  },
  linea: {
    '0x63ba74893621d3d12f13cec1e86517ec3d329837': { coingeckoId: 'liquity-usd', decimals: 18 }, //DONE
  },
  bevm: {
    '0x2967e7bb9daa5711ac332caf874bd47ef99b3820': { coingeckoId: 'wrapped-stbtc', decimals: 18 }, //DONE
  },
  real: {
    ...
    '0x75d0cbf342060b14c2fc756fd6e717dfeb5b1b70': { coingeckoId: 'dai', decimals: 18 }, //DONE
    '0x83fedbc0b85c6e29b589aa6bdefb1cc581935ecd': { coingeckoId: 'real-us-t-bill', decimals: 18 }, //DONE
    '0xAEC9e50e3397f9ddC635C6c429C8C7eca418a143': { coingeckoId: 'arcana-2', decimals: 18 }, // arcUSD //DONE
    '0xeAcFaA73D34343FcD57a1B3eB5B0D949df727712': { coingeckoId: 'arcana-2', decimals: 18 }, // PTa, 1:1 wrapped arcUSD //DONE
    '0x25ea98ac87A38142561eA70143fd44c4772A16b6': { coingeckoId: 'stack-2', decimals: 18 }, // MORE //DONE
  },
  taiko: {
    [ADDRESSES.null]: { coingeckoId: 'ethereum', decimals: 18 }, //DONE
    [ADDRESSES.taiko.WETH]: { coingeckoId: 'ethereum', decimals: 18 }, //DONE
    [ADDRESSES.taiko.USDC]: { coingeckoId: 'usd-coin', decimals: 6 }, //DONE
    [ADDRESSES.taiko.USDC_e]: { coingeckoId: 'usd-coin', decimals: 6 }, //DONE
    [ADDRESSES.taiko.USDT]: { coingeckoId: 'tether', decimals: 6 }, //DONE
  },
  sei: {
    '0x3894085ef7ff0f0aedf52e2a2704928d1ec074f1': { coingeckoId: 'usd-coin', decimals: 6 }, //DONE
    '0xb75d0b03c06a926e488e2659df1a861f860bd3d1': { coingeckoId: 'tether', decimals: 6 }, //DONE
    [ADDRESSES.null]: { coingeckoId: 'sei-network', decimals: 18 }, //DONE
    '0x160345fc359604fc6e70e3c5facbde5f7a9342d8': { coingeckoId: 'ethereum', decimals: 18 }, //DONE
    '0x5cf6826140c1c56ff49c808a1a75407cd1df9423': { coingeckoId: 'silo-staked-sei', decimals: 6 }, //DONE
    [ADDRESSES.sei.WSEI]: { coingeckoId: 'sei-network', decimals: 18 }, //DONE
  },
  core: {
    '0x5832f53d147b3d6cd4578b9cbd62425c7ea9d0bd': { coingeckoId: 'wrapped-bitcoin', decimals: 8 }, //DONE
    '0x5B1Fb849f1F76217246B8AAAC053b5C7b15b7dc3': { coingeckoId: 'solv-btc', decimals: 18 }, //DONE
  },
  lukso: {
    [ADDRESSES.lukso.WLYX]: { coingeckoId: 'lukso-token-2', decimals: 18 }, //DONE
  },
  planq: {
    [ADDRESSES.functionx.USDT]: { coingeckoId: 'usd-coin', decimals: 6 }, //DONE
    [ADDRESSES.planq.USDC_1]: { coingeckoId: 'usd-coin', decimals: 18 }, //DONE
  },
  zeta: {
    "0x1e4bF3CaBD7707089138dD5a545B077413FA83Fc": { coingeckoId: 'pufeth', decimals: 18 }, //DONE
  },
  etlk: {
  ...
  sanko: { 
    ...
    "0x754cdad6f5821077d6915004be2ce05f93d176f8": { coingeckoId: 'wrapped-dmt', decimals: 18 }, //DONE
    "0xe01e3b20c5819cf919f7f1a2b4c18bbfd222f376": { coingeckoId: 'sanko-bridged-weth-sanko', decimals: 18 }, //DONE
    "0x13d675bc5e659b11cfa331594cf35a20815dcf02": { coingeckoId: 'sanko-bridged-usdc-sanko', decimals: 6 }, //DONE
    "0x3c84f959f4b8ca0c39847d02f936e13fa8fc4eb9": { coingeckoId: 'beat-the-allegations', decimals: 18 }, // star
  },
  // WILL ADD THIS ONE IN A BIT
  xai: {
  ...
  arbitrum: {
    '0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34': { coingeckoId:'ethereum:0x4c9edd5852cd905f086c759e8383e09bff1e68b3', decimals:18 }
  }
}
