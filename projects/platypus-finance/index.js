...
async function getToa(pool, api) {
  const tokens = await api.call({  abi: 'function getTokenAddresses() view returns (address[])' , target: pool }) 
  const owners = await api.multiCall({  abi: 'function assetOf(address) view returns (address)', calls: tokens, target: pool })
...
async function tvl(timestamp, ethereumBlock, chainBlocks, { api }) {
  ...
  toa.push(['0xb599c3590f42f8f995ecfa0f85d2980b76862fc1', '0xc7388d98fa86b6639d71a0a6d410d5cdfc63a1d0'])
