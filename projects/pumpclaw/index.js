...
async function tvl(api) {
  ...
  // Sum token balances held in Uniswap V4 PoolManager
  // Each PumpClaw token is exclusively paired with ETH in a V4 pool
  // LP positions are locked forever in PumpClaw's LPLocker contract
