...
module.exports = {
  ...
  bsc: {
    tvl: sdk.util.sumChainTvls([
        ...
        sumTokensExport({ owner:'0xC4AE1E29aAe9D6cD898030b6e5cE4155B8268fCf', tokens: [ADDRESSES.bsc.USDT] })
      ])
  },
  ethereum: {
    tvl: sdk.util.sumChainTvls([
        sumTokensExport({ owner:'0xfc63831f1C517d196470F03a61afD3d0CC0f7127', tokens: [ADDRESSES.ethereum.USDT] }),
        sumTokensExport({ owner:'0xC4AE1E29aAe9D6cD898030b6e5cE4155B8268fCf', tokens: [ADDRESSES.ethereum.USDT] })
      ])
  },
  ton: {
