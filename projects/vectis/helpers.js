...
const connection = new Connection('https://api.mainnet-beta.solana.com');
 ...
 async function fetchAndDeserializeUserPositions(userAccountAddress) {
    try {
        const accountInfo = await connection.getAccountInfo(new PublicKey(userAccountAddress));
        if (!accountInfo) {
...
module.exports = { fetchAndDeserializeUserPositions};