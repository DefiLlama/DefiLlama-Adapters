...
async function getPerpMarketFundingRates(marketIndex) {
    const connection = getConnection();
    const perpMarketPda = getVaultPublicKey('perp_market', marketIndex);

    const accountInfo = await connection.getAccountInfo(perpMarketPda);
    if (!accountInfo) {
