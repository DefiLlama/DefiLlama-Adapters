...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/7jkta-eyaaa-aaaaq-aaarq-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for Kinic`,
  icp: { tvl: tvl },
}