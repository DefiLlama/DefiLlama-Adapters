...
async function tvl(_, block) {
  ...
  if (resp.status == 200 && resp.data.status == 1) {
    posTokens.push(
      ...resp.data.tokens
        ...
        .filter(
          (t) => t.target !== "0x7ebaa895e524d5646e7a5b686c47989b3b17aa5f"
        )
    );
  }
  ...
  let wrappedETHIndex = lockedPlasmaBalances.output.findIndex(
    (v) => v.input.target == "0xa45b966996374E9e65ab991C6FE4Bfce3a56DDe8"
  );
