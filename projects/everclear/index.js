...
const TOKENS_BY_CHAIN = {
  ...
  base: [
    ...
    "0xA0b73Cec... (replace with correct USDT on Base)", // USDT
  ],
  gnosis: [
    "0x4200000000000000000000000000000000000006", // WETH
  ...
  berachain: [
    "0xa05A3380889115bf313f1Db9d5f335157Be4D816", // WETH placeholder
  ],
  ronin: [
    "0xc99a6A985eD2Cac1ef41640596C5A5f9F4E19Ef5", // WETH 
    "0x0B7007c13325C48911F73A2daD5FA5dCBf808aDc", // USDC
...
const SPOKES_BY_CHAIN = {
  ...
  gnosis: ["0xe0F010e465f15dcD42098dF9b99F1038c11B3056","0xeFa6Ac3F931620fD0449eC8c619f2A14A0A78E99"], //100
  unichain: ["0xa05A3380889115bf313f1Db9d5f335157Be4D816","0x9ADA72CCbAfe94248aFaDE6B604D1bEAacc899A7"], //130
  zksync: ["0x7F5e085981C93C579c865554B9b723B058AaE4D3","0xbD82E5503461913a70566E66a454465a46F5C903"], //324
...
const chainTvl = (chain) => async (api) => {
  const owners = SPOKES_BY_CHAIN[chain] || [];
...
module.exports = {
  ...
  gnosis: { tvl: chainTvl("gnosis") },
  unichain: { tvl: chainTvl("unichain") },
  zksync: { tvl: chainTvl("zksync") },
  mantle: { tvl: chainTvl("mantle") },
  apechain: { tvl: chainTvl("apechain") },
  scroll: { tvl: chainTvl("scroll") },
  ink: { tvl: chainTvl("ink") },
  berachain: { tvl: chainTvl("berachain") },
  ronin: { tvl: chainTvl("ronin") },
  mode: { tvl: chainTvl("mode") },
  zircuit: { tvl: chainTvl("zircuit") },
  linea: { tvl: chainTvl("linea") },
  blast: { tvl: chainTvl("blast") },
  taiko: { tvl: chainTvl("taiko") },
  sonic: { tvl: chainTvl("sonic") },
}
