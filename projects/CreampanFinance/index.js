...
async function tvl(api) {
  ...
  api.sumTokens({ owner: factory_contract_address, tokens: [ADDRESSES.cronos.WCRO_1]})
  return api.sumTokens({ owner: factoryV2_contract_address, tokens: [ADDRESSES.cronos.WCRO_1]})
}
