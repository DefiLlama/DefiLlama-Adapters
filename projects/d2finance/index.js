...
const config = {
  ethereum: [
    ...
    '0x1F7BAe0549f9F0BAf15d0D637900056bB9434C36', // Debasement++ (XAUT)
  ],
  optimism: [
    '0xAFD240a8E564ad34663B6C42475027Ed083088a2', // Kimchi Premium (USDC)
    '0x20833F2E96aB236D66D18a0064e1e8171b70e22e', // Kimchi Corridor (USDC)
  ],
  robinhood: [
    '0x3a87f340c7aa52694c3dd806ba13d1b2ebf48dd8', // Global Macro (USDG)
  ],
  base: [
    '0x6c05A7d2c24B48fC3C615D294fEc2eB068548897', // dgnBTC V2
  ...
  hyperliquid: [
    ...
    '0x8ef30c5ce9a460bfae82f1f039f7c5e5427d7018', // hSOL
    '0x7410E69958a8ECE2A51C231C8528513d4d668C7a', // USDT0 Hyperliquid-RWA Strategies
    '0x140E81f8C033c0705036e55bE2F2fbce43e4595C', // dgnHYPE++
  ],
}
