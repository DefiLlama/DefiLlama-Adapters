...
module.exports = {
  doublecounted: true,
  methodology:
    'TVL is calculated from the outstanding LP Tokens issued by Dow Protocol vaults on BNB Smart Chain. Capital providers subscribe stablecoins (USDT/USDC) and receive LP Tokens representing their principal. TVL reflects the aggregate principal value of all outstanding LP Tokens across active vaults.',
  bsc: {
    tvl,
  },
}
