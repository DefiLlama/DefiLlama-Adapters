...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/x4kx5-ziaaa-aaaaq-aabeq-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for Modclub`,
  icp: { tvl: tvl },
}