const { sumTokens2, getAssociatedTokenAddress, getConnection } = require("../helper/solana");
...
async function tvl() {
  ...
  const { data: { data: mints } } = await axios.get('https://xpon-json-api-prod-650968662509.europe-west3.run.app/api/lyt-growth/standard-yield-tokens');
  ...
  for (let i = 0; i < mints.length; i++) {
    ...
    sdk.util.sumSingleBalance(balances, `solana:${mint.mintUnderlying}`, amount);
  }
