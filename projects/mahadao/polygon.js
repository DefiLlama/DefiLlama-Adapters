...
const polygon = {
  ...
  "quickswap.wethMahaLp": "0x6bbd28bb0eacd1f34d4c977a150439c96df9977e",

  arthu3poolStaking: "0x245AE0bBc1E31e7279F0835cE8E93127A13a3781",

  "curve.3pool.lp": "0xe7a24ef0c5e95ffb0f6684b813a78f2a3ad7d171",
  "curve.arthu3pool.lp": "0xDdE5FdB48B2ec6bc26bb4487f8E3a4EB99b3d633",
  "curve.arthu3pool.staking": "0x245AE0bBc1E31e7279F0835cE8E93127A13a3781",
  "curve.3pool.gauge": "0x19793b454d3afc7b454f206ffe95ade26ca6912c",
...
function pool2s() {
  return async (_timestamp, _ethBlock, chainBlocks) => {
    ...
    await sumTokens(
      ...
      [
        // quickswap ARTH/MAHA
        [polygon.arth, polygon["quickswap.arthMahaLp"]],
        [polygon.maha, polygon["quickswap.arthMahaLp"]],

        // quickswap WETH/MAHA
        [polygon.weth, polygon["quickswap.wethMahaLp"]],
        [polygon.maha, polygon["quickswap.wethMahaLp"]],
      ],
      chainBlocks.polygon,
      "polygon"
    );
    ...
    await getBalanceOfStakedCurveLP(
      balances,
      polygon["curve.arthu3pool.staking"], // staked
      polygon["curve.arthu3pool.lp"], // lp token
      [polygon["arth.usd"], polygon["curve.3pool.lp"]],
      chainBlocks.polygon,
      "polygon"
    );
