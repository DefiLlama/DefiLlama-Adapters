...
async function pool2(_timestamp, _ethBlock, chainBlocks) {
  ...
  const tokensAndOwners = [
    ...
    [bscTokens.ARTHuval3PS2, bscTokens.ARTHu3PXBasicStakingV2], // ellipsis masterchef, tvl belongs to them? SE: contains ARTH our stablecoin; we pay bribes for this tvl
...
async function tvl(ts, _block, chainBlocks) {
  ...
  const troves = [
    ...
    "0x7efC97EA11bc03bF5ABF4474Cb614C409Ef34957", // bnb
