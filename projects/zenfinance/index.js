...
module.exports = {
  methodology: "ZenFinance TVL includes ARY staked in ZenStake, ARY staked in ZenRecharge, tokens in ZenRecharge, and CRO in ZenSwap competitions",
  start: 1726238297, // Sep 13, 2025 - ZenStake deployment date
  cronos: {
    tvl,
    staking: stakings(ZENSTAKE_CONTRACT, ARY_TOKEN),
  }
};
