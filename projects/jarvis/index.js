...
const contracts = {
  ethereum: {
    ...
    synthCollateralContracts: [
      ...
      "0xF47Ff36956105255E64455BfEDe4538768439066",
      "0x2431b64cDD6D7E9A630046d225BA4F01B3AC9D3b",
    ...
    liquidityPools: [
      "0x833407f9c6C55df59E7fe2Ed6fB86bb413536359",
      "0x2D8b421F3C6F14Df2887dce70b517d87d11af1E0",
      "0x6FF556740b30dFb092602dd5721F6D42c66A1580",
    ], // Not AMM LP pools, just pools where money is waiting to be used for minting
  },
  polygon: {
...
function chainTvl(chain) {
  return async (timestamp, ethBlock, chainBlocks) => {
    ...
    const { synthCollateralContracts, liquidityPools, usdcToken } =
      contracts[chain];

    const collateralTokens = await sdk.api.abi.multiCall({
      abi: "erc20:balanceOf",
      calls: synthCollateralContracts
        .concat(liquidityPools)
        .map((contract) => ({
          target: usdcToken,
          params: [contract],
        })),
