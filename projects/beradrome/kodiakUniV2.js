...
async function updateKodiakUniV2Tvl(api, pluginAddress, balances, transform) {
    ...
    const reserves = await api.call({
        abi: 'function getReserves() view returns (uint256,uint256,uint32)',
        target: pairAddress
    });
