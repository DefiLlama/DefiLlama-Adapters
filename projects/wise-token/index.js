...
module.exports = {
  ...
  methodology: 'RWA TVL = totalSupply of wtnUSDC + wtnUSDT receipt tokens (1:1 with deposited stables). Principal is forwarded to World Mobile for AirNodes; vaults only hold claimable interest. Liquidity TVL = tvlLiquidity from WISE\'s public globals/tvl API, representing WISE/ETH Uniswap liquidity (staked WISE is not counted separately to avoid double-counting the token already valued via the LP).',
  ethereum: { tvl, pool2 },
  arbitrum: { tvl },
  base: { tvl },
}
