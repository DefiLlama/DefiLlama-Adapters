...
async function fetchLiquidity() {
  const klayswapInfo = await retry(
    async (bail) =>
      await axios.get("https://s.klayswap.com/stat/klayswapInfo.json")
  );
...
module.exports = {
  methodology:
    'TVL counts the liquidity of KlaySwap DEX and staking counts the KSP that has been staked. Data is pulled from:"https://s.klayswap.com/stat/klayswapInfo.json".',
  klaytn: {
    tvl: fetchLiquidity,
