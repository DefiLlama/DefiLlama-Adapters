...
async function suiTVL(api) {
    const package = "0x8462eb7e1c52018f42f2dd2c33605f7212ad8702739a5eaacb0e1a0106f3dc6a";
    ...
    for (const vault of vaultList) {
        ...
        const [coinA, coinB] = await suiTx.getVaultTokenBalance(package, [lp_type, coin_type_a, coin_type_b], id, clmm_pool);
