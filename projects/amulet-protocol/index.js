...
module.exports = {
    ...
    methodology: `Amulet provides solution which allows user to earn rewards from underwriting covers with SOL derivatives token (amtSOL). Hence, the amount of SOL derivatives staked are counted as our TVL which the value are calculated based on the price get from Coingecko.`,
    hallmarks: [
