  ...
  for (let i = 0; i < anchor.length; i++) {
    ...
    for (contract of fundedContracts) {
      ...
      totalCoins =
        Number(totalCoins) +
        Number(
          (contractTokenBalance * pricePerShare * 10 ** tokenDecimals) /
            10 ** 18
        );
    }
...
module.exports = {
  ...
  tvl,
  methodology:
    "counts the value of each stablecoin, and interest-bearing anchor-stable, in the TransparentUpgradeableProxy contracts.",
};
