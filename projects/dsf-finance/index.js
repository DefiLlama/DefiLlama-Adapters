...
async function ethTvl(timestamp, block, _, { api }) {
  api.add(ADDRESSES.ethereum.USDT, await api.call({ abi: "uint256:totalHoldings", target: DSF_Contract_usdLP, }))
  api.add(ADDRESSES.ethereum.USDT, await api.call({ abi: "uint256:totalHoldings", target: DSF_Contract_Old_contract, }))
}
