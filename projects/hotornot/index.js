...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/67bll-riaaa-aaaaq-aaauq-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for HotOrNot`,
  icp: { tvl: tvl },
}