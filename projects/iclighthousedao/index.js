...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/hjcnr-bqaaa-aaaaq-aacka-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for ICLighthouse DAO`,
  icp: { tvl: tvl },
}