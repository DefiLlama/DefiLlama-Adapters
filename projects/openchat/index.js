...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/3e3x2-xyaaa-aaaaq-aaalq-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for OpenChat`,
  icp: { tvl: tvl },
}