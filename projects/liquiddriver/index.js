...
const minichefTvl = async (timestamp, ethBlock, chainBlocks) => {
    ...
    if (symbols.output[idx].success) {
      if (token === "0x936D23C83c2469f6a14B9f5bEaec13879598A5aC") { // ICE-FTM SPIRIT LP
        try {
          ...
          console.log('ice-ftm pool tvl error :>> ', error);
        }
        ...
        if (symbols.output[idx].output === "3poolV2-f") {
          try {
            ...
            console.log('3poolv2-f pool tvl error :>> ', error);
          }
          ...
          try {
            ...
            console.log('BPT_LINSPIRIT pool tvl error :>> ', error);
          }
          ...
          try {
            ...
            console.log('BPT-QUARTET pool tvl error :>> ', error);
          }
          ...
          try {
            ...
            console.log('FTM-OPERA pool tvl error :>> ', error);
          }
          ...
          try {
            ...
            console.log('BPT_liHND pool tvl error :>> ', error);
          }
          ...
          try {
            ...
            console.log('DEI-USDC pool tvl error :>> ', error);
          }
        } else {
          sdk.util.sumSingleBalance(
            balances,
  ...
  try {
    ...
    console.log('linspirit staking tvl error :>> ', error);
  }
  ...
  try {
    ...
    console.log('lihnd staking tvl error :>> ', error);
  }
...
const hundredchefTvl = async (timestamp, ethBlock, chainBlocks) => {
  ...
  try {
    ...
    console.log('hundred pools tvl error :>> ', error);
  }
