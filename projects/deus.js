...
async function fetch() {
  ...
  var vaultLockedValue = await new BigNumber(tvl_details.vaultLockedValue)
  ...
  tvl = tvl.plus(stakingLockedValue).plus(vaultLockedValue).plus(uniswapLockedValue).plus(etherLockedInMarketMaker)
  return tvl
}
