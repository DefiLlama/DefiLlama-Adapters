...
const config = {
  ...
  // avax: {
  //   owners: [
  //     "0xeD8D8f4Ff53915D80987BCD51C2DE582a05b2322"
  //   ],
  // },
  // cardano: {
  //   owners: [
  ...
  // elrond: {
  //   owners: [
  //     "erd1z5xjeu4xw32jkckhj9jpc9dymj6a9h8yxtch96e43ncp6fhuzpnqshqutj"
  //   ],
  // },
  // eos: {
  //   owners: [
  ...
  // terra: {
  //   owners: [
  //     "terra1zjq4jdvqtruvxgug64rn0p06kvp7r3qpxzrxdg" //hot wallet
  //   ],
  // },
  // terra2: {
  //   owners: [
  //     "terra13x5jkljx69vyak47k9e9u9qetu0sckxpfysrp7" //hot wallet
  //   ],
  // },
  // tezos: {
  //   owners: [
