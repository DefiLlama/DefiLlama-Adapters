...
const v2EndPoints = {
  ethereum: `https://gateway-arbitrum.network.thegraph.com/api/${process.env.GRAPH_PROTOCOL}/subgraphs/id/Cquw1hbmvNrSvUjaqoRhu9nWv7AX1Mz2gEb9sapYdMA5`,
  polygon: `https://gateway-arbitrum.network.thegraph.com/api/${process.env.GRAPH_PROTOCOL}/subgraphs/id/Ami8CcwigwYViJsUrwqK8DWwDPtFVAKbeYfii6ANahax`,
  bsc: `https://gateway-arbitrum.network.thegraph.com/api/${process.env.GRAPH_PROTOCOL}/subgraphs/id/EsA5LyABgi7ibZJGNr5PQsQ2L8QDPZxNdDvd5qPs5CJj`,
}
