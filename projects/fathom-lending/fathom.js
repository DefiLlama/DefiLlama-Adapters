...
async function getV2Reserves(block, addressesProviderRegistry, chain, dataHelperAddress, abis = {}) {
  ...
  const aTokenMarketData = (
    await sdk.api.abi.multiCall({
      ...
      abi: abis.getAllFmTokens || abi["getAllFmTokens"],
      block,
      chain
    })
  ).output;
...
function fathomExports(chain, addressesProviderRegistry, transform = undefined, dataHelpers = undefined, { oracle, abis, v3 = false, blacklistedTokens = [], hasV2LPs = false, } = {}) {
  return {
