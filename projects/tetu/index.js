...
const BSC_BOOKKEEPER = "0x8A571137DA0d66c2528DA3A83F097fbA10D28540";
const BSC_CONTRACT_READER = "0xE8210A2d1a7B56115a47B8C06a72356773f6838E";
const BSC_USDC = "bsc:0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d";
...
const bscTvl = async (timestamp, ethBlock, chainBlocks) => {
  ...
  for (let i = 0; i < vaultLength; i++) {
    ...
    // vaultTvlUsdc returns 18 decimals but USDC has 6
    sdk.util.sumSingleBalance(balances, BSC_USDC,
        BigNumber(usdcBal).toFixed(0));
  }
