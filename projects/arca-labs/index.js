...
module.exports = {
  ethereum: {
    tvl: async (api) => {
      ...
      const rcoinToUsdcDecimalAdjustment = Math.pow(10, usdcDecimals) / Math.pow(10, rcoinDecimals);
      return api.add(ADDRESSES.ethereum.USDC, totalSupply * rcoinToUsdcDecimalAdjustment)
    }
  }
}