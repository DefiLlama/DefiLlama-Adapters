...
const polygonTvl = async (timestamp, ethBlock, chainBlocks) => {
  ...
  for (let index = 0; index < poolLength; index++) {
    ...
    if (
      ...
      token === "0x388E2a3d389F27504212030c2D42Abf0a8188cd1"
    ) {
      // DINO and stkGHOST-ETH
      continue;
    }
  ...
  balances["polygon:0xAa9654BECca45B5BDFA5ac646c939C62b527D394"] =
    balances["0x2701e1d67219a49f5691c92468fe8d8adc03e609"];
