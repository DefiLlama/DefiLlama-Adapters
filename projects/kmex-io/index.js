...
module.exports = {
  kava: {
    staking: sumTokensExport({ chain: 'kava', owner: kmexStaking, tokens: [kavaKMX],lps: [kavaKMXKAVAPool], useDefaultCoreAssets: true, }),
    tvl: gmxExports({ chain: 'kava', vault: kmexVault, })
  },
};
