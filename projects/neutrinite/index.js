...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/extk7-gaaaa-aaaaq-aacda-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for Neutrinite`,
  icp: { tvl: tvl },
}