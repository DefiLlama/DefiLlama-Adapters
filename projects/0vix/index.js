...
// The compoundExports2 function is used to export the TVL and borrowed values for the specified Compound protocol.
...
module.exports = {
  ...
  // The polygon property contains the TVL and borrowed values for the Polygon network.
