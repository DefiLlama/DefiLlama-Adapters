...
async function pool2(_timestamp, block) {
  const balance = await sdk.api.abi
    .call({
      abi: "erc20:balanceOf",
...
module.exports = {
  methodology:
    "TVL counts tokens that have been deposited to the yield farming vaults. Pool2 TVL counts SushiSwap LP tokens (USDC-XYZ) that have been deposited to the yield farm.",
  ethereum: {
    tvl,
  },
  pool2: {
