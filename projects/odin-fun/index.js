...
async function tvl() {
  ...
  if (!Number.isFinite(launchpadMSats) || !Number.isFinite(ammMSats)) {
    throw new Error(`Invalid Odin.fun TVL payload: launchpad_btc=${response.launchpad_btc}, amm_btc=${response.amm_btc}`)
  }
  return {
