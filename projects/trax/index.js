...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/ecu3s-hiaaa-aaaaq-aacaq-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for Trax`,
  icp: { tvl: tvl },
}