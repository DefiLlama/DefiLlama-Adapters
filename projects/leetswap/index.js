...
module.exports = {
  ...
  op_bnb: { tvl: getUniTVL({ factory: ADDRESSES.shibarium.BONE_4, useDefaultCoreAssets: true,  }), },
  ...
  manta: { tvl: getUniTVL({ factory: ADDRESSES.shibarium.BONE_4, useDefaultCoreAssets: true,  }), },
}
