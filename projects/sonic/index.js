...
const SNS_URL = "https://sns-api.internetcomputer.org/api/v1/snses/qtooy-2yaaa-aaaaq-aabvq-cai"
...
module.exports = {
  methodology: `We count the ICP on the treasury account as the collateral for Sonic`,
  icp: { tvl: tvl },
}