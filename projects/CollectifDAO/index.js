...
module.exports = {
	...
	filecoin: {
		tvl: async (_, _1, _2, { api }) => {
			const fetchCollateral = async (owner) => api.call({ abi: getCollateralABI, target: COLLECTIF_SPS_COLLATERAL_CONTRACT, params: [owner.slice(2)] });
			...
			const totalCollateral = collaterals.reduce((acc,cur) => {
