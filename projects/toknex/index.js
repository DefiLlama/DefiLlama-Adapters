// The same two vault addresses are intentionally deployed on both Ethereum and BSC.
const vaults = {
  ethereum: [
...
async function tvl(api) {
  const stats = await api.multiCall({ abi: vaultStatsAbi, calls: vaults[api.chain] })
