...
module.exports = {
    ...
    bsc: {
        staking: stakings([StakingV1, StakingV2Pool1, StakingV2Pool2, StakingV2Pool3, StakingV2Pool4, VestingCEXV1, VestingCEXV2, VestingAdvisors, VestingTeam, VestingMarketing], MTS_TOKEN, 'bsc'),
        tvl: () => ({}),
    }
} 