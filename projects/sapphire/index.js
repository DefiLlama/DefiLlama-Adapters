...
const poolInfo = {
  ...
  outputs: [
    ...
    { internalType: "uint256", name: "accfSapphirePerShare", type: "uint256" },
...
module.exports = {
  ...
  fantom: {
    tvl,
    pool2: pool2s(
      [chef, sapphireWarChef],
      [sapphireFtmLP, sapphireWarFtmLP],
      "fantom"
    ),
    staking,
    masterchef: tvl,
