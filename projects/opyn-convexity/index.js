...
const getNumberOfOptionsContractsAbi = require('../opyn/abis/convexity/getNumberOfOptionsContracts.json');
const optionsContractsAbi = require('../opyn/abis/convexity/optionsContracts.json');
const collateralAbi = require('../opyn/abis/convexity/collateral.json');
